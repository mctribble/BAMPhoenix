...
/** 
 * @author Roktim
 * Testing the DaysDTO getter and setter, no-args constructor
...
public class DaysDTOTest {
    ...
    public void gettersAndSettersShouldWorkForEachProperty() {
        assertThat(DaysDTO.class, hasValidGettersAndSetters());
    }
    //PASS: Ensure all properties on the bean are included in the string value.
    @Test
    public void allPropertiesShouldBeRepresentedInToStringOutput() {
        assertThat(DaysDTO.class, hasValidBeanToString());
